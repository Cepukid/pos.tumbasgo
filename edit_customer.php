        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title font-weight-bold text-primary" style="color: #414FB7;">Update Informasi Pelanggan</h3>
            ...
            <form role="form" id="quickForm" method="post" action="edit_customer.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputAddress">Alamat Pelanggan</label>
              ...
              <div class="card-footer">
                <button type="submit" id="update_customer" class="btn btn-primary"><i class="fa fa-check-circle"></i> Update Pelanggan</button>
              </div>
            </form>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#update_customer', function (e) {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        customer_name: {
          required: "Mohon masukkan nama pelanggan"
        },
        email: {
        ...
        customer_phone: {
          required: "Mohon masukkan nomor telepon pelanggan"
        },
        customer_address: {
          required: "Mohon masukkan alamat pelanggan"
        },
