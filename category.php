                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_category.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Tambah Kategori
                            </button>
                            <h3 class="card-title font-weight-bold text-primary" style="color: #414FB7;"">Infomasi Kategori</h3>
