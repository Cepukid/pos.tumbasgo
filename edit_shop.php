        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title font-weight-bold text-primary" style="color: #414FB7;">Update Informasi Toko</h3>
            ...
            <form role="form" id="quickForm" method="post" action="edit_shop.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputshopName">Nama Toko</label>
                ...
                <div class="form-group">
                  <label for="exampleInputAddress">Alamat Toko</label>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleShopStatus">Status Toko</label>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#update_shop', function (e) {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        shop_name: {
          required: "Mohon masukkan nama toko"
        },
        email: {
        ...
        shop_phone: {
          required: "Mohon masukkan nomor telepon toko"
        },
        shop_address: {
          required: "Mohon masukkan alamat toko"
        },
