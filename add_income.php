...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $result = mysqli_query($con, "SELECT * FROM income WHERE shop_id=$shop_id AND income_name = '$income_name' AND income_note= '$income_note' AND income_time='$income_time' AND income_date='$income_date'");
  $num_rows = mysqli_num_rows($result);


  if ($num_rows > 0) {
    echo '<script type="text/javascript">';
    echo 'setTimeout(function () { swal.fire("ERROR!","Pemasukan sudah ada!","error");';
    echo '}, 500);</script>';
  } else {
    if (mysqli_query($con, "INSERT INTO income (`income_name`,`income_note`,`income_amount`,`income_time`,`income_date`,`shop_id`) VALUE ('$income_name','$income_note','$income_amount','$income_time','$income_date','$shop_id')")) {
      echo '<script type="text/javascript">';
      echo 'setTimeout(function () { swal.fire("Pemasukan berhasil ditambahkan!","Done!","success");';
      echo '}, 500);</script>';
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title">Tambah Informasi Pemasukan</h3>

            </div>


            <form role="form" id="quickForm" method="post" action="add_income.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputPhone">Total Pemasukan</label>
                  <input type="number" name="income_amount" class="form-control" id="exampleInputAmount"
                         placeholder="Masukkan Total Pemasukan">
                </div>

                <div class="form-group">
                  <label for="exampleInputAddress">Waktu Pemasukan</label>
                  <input type="time" name="income_time" class="form-control" id="exampleInputTime"
                         placeholder="Masukkan Waktu pemasukan">
                </div>

                <div class="form-group">
                  <label for="exampleInputAddress">Tanggal Pemasukan</label>
              ...
              <div class="card-footer">
                ...
                <button type="submit" id="add_income" class="btn btn-primary"><i class="fa fa-check-circle"></i> Tambah
                </button>
              </div>
            </form>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#add_income', function (e) {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        income_name: {
          required: "Tolong masukkan Nama Pemasukan"
        },
        income_note: {
          required: "Tolong masukkan Catatan Pemasukan",
        },
        income_amount: {
          required: "Tolong masukkan Total Pemasukan"
        },
        income_time: {
          required: "Tolong masukkan Waktu Pemasukan"
        },

        income_date: {
          required: "Tolong masukkan Tanggal Pemasukan"
        },
