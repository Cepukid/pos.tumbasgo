        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title font-weight-bold text-primary" style="color: #414FB7;">Tambah Informasi Pemasok</h3>
            ...
            <form role="form" id="quickForm" method="post" action="add_suppliers.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputsuppliersName">Nama Pemasok</label>
                ...
                <div class="form-group">
                  <label for="exampleInputPhone">Nomor Telepon Pemasok</label>
              ...
              <div class="card-footer">
                ...
                <button type="submit" id="add_suppliers" class="btn btn-primary"><i class="fa fa-check-circle"></i> Tambah Pemasok
                </button>
              </div>
            </form>
