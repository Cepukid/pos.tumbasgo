        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <h3 class="card-title font-weight-bold text-primary" style="color: #414FB7;">Update Informasi Kategori</h3>
            ...
            <form role="form" id="quickForm" method="post" action="edit_category.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="exampleInputCategoryName">Nama Kategori Produk</label>
              ...
              <div class="card-footer">
                <button type="submit" id="update_category" class="btn btn-primary"><i class="fa fa-check-circle"></i> Update Kategori</button>
              </div>
            </form>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#update_category', function (e) {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        product_category_name: {
          required: "Mohon masukkan nama kategori"
        },
